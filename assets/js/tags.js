export const iconTags = {
  'java': require('static/icon/tag/java.png'),
  'python': require('static/icon/tag/python.png'),
  'android': require('static/icon/tag/android.png'),
  'chrome': require('static/icon/tag/chrome.png'),
  'firefox': require('static/icon/tag/firefox.png'),
  'amazon-web-services': require('static/icon/tag/amazon-web-service.png'),
  '以太坊': require('static/icon/tag/ether.png'),
  '比特币': require('static/icon/tag/bitcoin.png'),
  '区块链': require('static/icon/tag/block-chain.png'),
  'flutter': require('static/icon/tag/flutter.png'),
  '黑客马拉松': require('static/icon/tag/hackathon.png'),
  'html5': require('static/icon/tag/html5.png'),
  'ios': require('static/icon/tag/ios.png'),
  'jquery': require('static/icon/tag/jquery.png'),
  'mongodb': require('static/icon/tag/mongodb.png'),
  'mysql': require('static/icon/tag/mysql.png'),
  'raspberry-pi': require('static/icon/tag/raspberry-pi.png'),
  'ruby': require('static/icon/tag/ruby.png'),
  '七牛云存储': require('static/icon/tag/seven-cattle.jpg'),
  '小程序': require('static/icon/tag/small-program.png'),
  'twitter': require('static/icon/tag/twitter.png'),
  'ubuntu': require('static/icon/tag/ubuntu.png'),
  '人工智能': require('static/icon/tag/artificial-intelligence.png'),
  'javascript': require('static/icon/tag/front-end.png'),

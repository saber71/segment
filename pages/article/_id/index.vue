    ...
    <section class="guess-like">
      ...
      <ul>
        <li class="item" v-for="val in guessLikeArticles">
          <nuxt-link class="name" :to="'/article/'+val.id">{{val.name}}</nuxt-link>
      ...
      <section class="content-part">
        <section class="comment" v-for="val in comments">
          ...
          <section class="text">
            ...
            <section class="sub-comments" v-show="val.subComments.length>0">
...
<script>
  ...
  import {DEFAULT_LAYOUT_SCROLL_TO, eventBus, ON_DEFAULT_LAYOUT_SCROLL, ON_MD_INDEX_CHANGE_TITLE, SHOW_LOGIN__CARD, SUCCESS_LOGIN} from "../../../assets/js/event-bus";
  ...
  export default {
    name: "index",
    components: {Tag, MButton, MdIndex, UserAuthentication, Breadcrumb, MdRender},
    props: {},
    head() {
      return {
    ...
    async asyncData({app, params}) {
      ...
      comments.forEach(val => val.reply = false)
